...
router.post('/registro', validarRegistro, async (req, res) => {
  ...
  try {
    ...
    await t.rollback();
    console.error('[SEMK][auth] Error en /registro:', err);
...
router.post('/login', validarLogin, async (req, res) => {
  ...
  try {
    ...
    // Buscar la sesion de test mas reciente de este usuario, si existe
    ...
    console.error('[SEMK][auth] Error en /login:', err);
